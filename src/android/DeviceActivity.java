...
public class DeviceActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(getResources().getIdentifier("screen_device", "layout", getPackageName()));
        // }
        ...
        mPinpadManager.setOnConnectionEstablishedListener(new PinpadManager.OnConnectionEstablishedListener() {
            ...
            public void OnConnectionEstablished() {
                ...
                String storedPinpadMacAddress = MiscUtils.getFromSharedPreferences(ReferenceList.preference,
                        ReferenceList.pinpadMACAddress, "");

                if (!storedPinpadMacAddress.equals(btAddress)) {// new pinpad or not the current pinpad app recognises
                    Globals.loadKeys = true;
                    MiscUtils.storeInSharedPreferences(ReferenceList.preference, ReferenceList.pinpadMACAddress,
                            btAddress);
                }
        ...
        if (Globals.autoConnect) {
            MiscUtils.initContext(getApplicationContext());
            String pinpadMacAddress = MiscUtils.getFromSharedPreferences(ReferenceList.preference,
                    ReferenceList.pinpadMACAddress, "");
    ...
    private void showConnectPinpadDialog() {
        ...
        mListView = (ListView) findViewById(getResources().getIdentifier("listView", "id", getPackageName()));
        ...
        findViewById(getResources().getIdentifier("cancel", "id", getPackageName()))
    ...
    private void connectToDevice(final String btAddress) {
        ...
        // Construct a progress dialog to prevent user from actions until connection is
        // finished.
